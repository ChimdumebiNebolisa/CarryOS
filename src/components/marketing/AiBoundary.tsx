export function AiBoundary() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-20 sm:px-6">
      <p className="mono text-xs uppercase tracking-[0.18em] text-[var(--graphite)]">AI boundary</p>
      <h2 className="mt-3 max-w-3xl text-4xl">The model may suggest. You approve. Evidence decides.</h2>
